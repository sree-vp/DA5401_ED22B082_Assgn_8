...
**Submission details**
- A single file named DA_Lab_8_ED22B082 contains all the code and explanation.
- Two different approaches are tried - one using time series and one using random split. Both are presented consecutively with markdowns.
